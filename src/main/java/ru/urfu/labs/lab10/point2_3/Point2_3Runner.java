...
/**
 * Консольное меню для задания 2.3 по работе с JSON-файлом домашних животных.
 */
public class Point2_3Runner {

    private static final AnimalJsonRepository REPOSITORY = new AnimalJsonRepository();
    ...
    private static void addAnimal(Scanner scanner) throws Exception {
        ...
        System.out.println("Животное добавлено в JSON.");
    }
